 ...
 * <ul>
 *   <li>{@link OCL.TuplePart#getTuple <em>Tuple</em>}</li>
 * </ul>
 * </p>
 *
 * @see OCL.OCLPackage#getTuplePart()
 * @model
 * @generated
 */
public interface TuplePart extends VariableDeclaration {
	 ...
	 * It is bidirectional and its opposite is '{@link OCL.TupleExp#getTuplePart <em>Tuple Part</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see OCL.OCLPackage#getTuplePart_Tuple()
	...
	/**
	 * Sets the value of the '{@link OCL.TuplePart#getTuple <em>Tuple</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
